(() => {
  ...
  const questions = [
    q("Pressure", "A group project is due tonight, and the shared file has become unusable. Where do you begin?", [["Work backward through the versions until I find the last intact copy and the exact point of failure.",["analysis","composure","pragmatism"]],["Call the person who is spiraling, give them one section, and stay on the line while they finish it.",["empathy","warmth","sociability"]],["Split the remaining work into names and deadlines, then take responsibility for the final upload.",["authority","duty","pragmatism"]],["Start a clean document and tell everyone to send me whatever they can salvage in the next twenty minutes.",["defiance","candor","authority"]]]),
    q("Trust", "A new coworker offers to cover a difficult task for you before you know them well. How do you respond?", [["Ask what they need from me in return and how they learned the task so quickly.",["analysis","caution","pragmatism"]],["Accept, thank them properly, and use the chance to get to know them.",["idealism","warmth","curiosity"]],["Decline for now; unexpected generosity can wait until the relationship is clearer.",["caution","defiance","composure"]],["Accept only if we divide the work openly and keep the rest of the team informed.",["authority","sociability","candor"]]]),
    q("Friendship", "A close friend says they are fine, but they have canceled three plans and stopped replying normally. How do you respond?", [["Give them some room while quietly checking whether anything specific has changed.",["analysis","caution","empathy"]],["Tell them I believe their words, but not the distance, and ask what kind of support would feel useful.",["candor","empathy","warmth"]],["Ask directly what they are not telling me, even if they are annoyed by the question.",["defiance","candor","idealism"]],["Drop off dinner and handle one practical thing before asking them to explain themselves.",["pragmatism","duty","composure"]]]),
    q("Authority", "A new workplace rule makes life harder for junior staff while barely affecting management. What do you do?", [["Study the wording and use every legitimate exception to demonstrate how badly the policy works.",["analysis","defiance","caution"]],["Challenge it in the next meeting and make clear that I am willing to be named as the objection.",["authority","idealism","candor"]],["Help the affected staff work around it safely, then build a documented case for changing it.",["duty","pragmatism","composure"]],["Ask the junior staff what response they want before turning their situation into my cause.",["empathy","candor","sociability"]]]),
    ...
    q("Betrayal", "A friend breaks an important promise for reasons you understand. How do you respond?", [["Tell them that understanding the reason does not erase what the broken promise cost.",["candor","composure","duty"]],["Ask whether we can rebuild the friendship if neither of us simplifies what happened.",["empathy","warmth","idealism"]],["Use what I know about the reason to decide whether they are likely to do it again.",["analysis","pragmatism","caution"]],["Confront them before they send a carefully edited explanation by text.",["defiance","authority","candor"]]]),
    q("Grief", "Someone close to you has stopped answering messages after a loss. What do you offer?", [["Leave groceries outside, sit nearby for a while, and make clear that neither requires a response.",["warmth","empathy","composure"]],["Handle one neglected errand and write down the three things that genuinely cannot wait until next week.",["duty","pragmatism","caution"]],["Tell them they can speak honestly about resentment, relief, or anger without having those feelings corrected.",["candor","empathy","defiance"]],["Help them understand what decisions remain without pretending practical clarity makes the loss smaller.",["analysis","idealism","formality"]]]),
    ...
    q("Risk", "Which risk would you take with the least hesitation?", [["Traveling across town late at night because someone I love should not have to get home alone.",["warmth","sociability","empathy"]],["Being the only person in a group to object when everyone else wants to let something unfair pass.",["defiance","idealism","candor"]],["Taking responsibility for a difficult decision everyone has discussed without volunteering to own.",["duty","authority","composure"]],["Trying something I am not qualified for yet because I want to understand how it works.",["curiosity","analysis","caution"]]]),
    ...
    q("Belonging", "A new person in your workplace or friend group keeps missing unwritten social rules. How do you respond?", [["Explain the rules privately, including which ones no one takes very seriously.",["empathy","formality","pragmatism"]],["Ask why the group expects only the new person to adapt.",["idealism","defiance","curiosity"]],["Give them a clear role in the next shared task so they have a natural way into the group.",["duty","authority","sociability"]],["Watch for a while; awkwardness may not be the only reason they are being kept at a distance.",["caution","analysis","composure"]]]),
    q("Justice", "A manager speaks harshly to a junior employee over a small mistake while everyone else stays quiet. What do you do?", [["Interrupt and say directly that the mistake does not justify speaking to them that way.",["candor","defiance","duty"]],["Write down what was said, when it happened, and whether this has happened before.",["analysis","curiosity","caution"]],["Check on the employee privately and ask what response would actually help them.",["empathy","warmth","composure"]],["Use whatever influence I have to change who handles mistakes and how they are reviewed.",["authority","pragmatism","idealism"]]]),
    ...
    q("Planning", "You decide to spend the next year making one meaningful change in your life. Where do you begin?", [["Write down the time, money, other people, and likely excuses the change will have to survive.",["analysis","caution","pragmatism"]],["Find people who want something similar and can keep one another committed after the excitement fades.",["sociability","idealism","authority"]],["Make one small version that improves an ordinary day before designing the perfect long-term plan.",["empathy","duty","pragmatism"]],["Make sure the goal is actually mine and not a respectable life someone else chose for me.",["defiance","candor","curiosity"]]]),
    q("Strangers", "A stranger at a café asks you to watch their bag while they use the restroom. How do you answer?", [["Tell them I am not comfortable being responsible for something I know nothing about.",["candor","caution","defiance"]],["Agree if I am staying put anyway and nothing about the request feels immediately wrong.",["warmth","pragmatism","empathy"]],["Ask how long they will be gone and keep the bag in view without touching it.",["analysis","formality","caution"]],["Agree, point out exactly where I will be sitting, and ask when they expect to return.",["authority","duty","sociability"]]]),
